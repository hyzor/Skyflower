...
#define JUMP_VELOCITY_LOW 30.0f
#define JUMP_VELOCITY_DEFAULT 40.0f
#define JUMP_VELOCITY_HIGH 45.0f

#define MOVEMENTSPEED_LOW 25.0f
#define MOVEMENTSPEED_DEFAULT 50.0f
#define MOVEMENTSPEED_HIGH 75.0f

#define PROJECTILE_HEIGHT_LOW -10.0f
#define PROJECTILE_HEIGHT_MEDIUM_LOW 0.0f
#define PROJECTILE_HEIGHT_MEDIUM 5.0f
#define PROJECTILE_HEIGHT_MEDIUM_HIGH 10.0f
#define PROJECTILE_HEIGHT_HIGH 20.0f
