...
public:
	...
	virtual void Walk(Vec3 &pos, float speed = MOVEMENTSPEED_DEFAULT, bool useVelocity = false) = 0;
	virtual void Strafe(Vec3 &pos, float speed = MOVEMENTSPEED_DEFAULT, bool useVelocity = false) = 0;

	virtual void MoveUp(Vec3 &pos) = 0;
	virtual void MoveDown(Vec3 &pos) = 0;
	virtual Vec3 MovePushed(Vec3 pos) = 0;

	virtual void RotateRelativeVec3(Vec3 &rot, Vec3 relativeVec, float angleY) = 0;
