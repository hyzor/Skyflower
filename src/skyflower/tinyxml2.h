...
private:
    ...
    T*  _mem;
    T   _pool[INIT];
    int _allocated;		// Entitys allocated
    int _size;			// number Entitys in use
};


/*
	Parent virtual class of a pool for fast allocation
	and deallocation of Entitys.
*/
class MemPool
{
public:
...
/** XMLNode is a base class for every Entity that is in the
	XML Document Entity Model (DOM), except XMLAttributes.
...
public:
    ...
    */
    ...
    /**
    	...
    	this Document. The memory for the Entity
    	is managed by the Document.
...
/**
	...
	See also XMLConstHandle, which is the same as XMLHandle, but operates on const Entitys.
*/
