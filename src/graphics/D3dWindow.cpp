...
void D3dWindow::SetResolution(UINT Width, UINT Height)
{
	mClientWidth = Width;
...
void D3dWindow::CalculateFrameStats()
{
...
UINT D3dWindow::GetWindowWidth() const
{
	return mClientWidth;
}

UINT D3dWindow::GetWindowHeight() const
{
...
void D3dWindow::SetFullscreen(bool toFullscreen)
{
	mIsFullscreen = toFullscreen ? TRUE : FALSE;

	// Pause and stop timer while setting to fullscreen
	mAppPaused = true;
	mTimer->stop();
...
void D3dWindow::SwitchFullscreen()
{
	mIsFullscreen = !mIsFullscreen;
	SetFullscreen(mIsFullscreen != FALSE);
}

bool D3dWindow::IsFullscreen()
{
